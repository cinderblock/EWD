declare module 'node-pkware' {
  ...
  type Handler = (
    chunk: Buffer,
    encoding: unknown,
    callback: (error: Error | undefined, output: Buffer) => void,
  ) => void;
  ...
  export enum CompressionType {
    Binary = constants.COMPRESSION_BINARY,
    Ascii = constants.COMPRESSION_ASCII,
  }

  // type DictionarySizeBits = typeof constants.DICTIONARY_SIZE_SMALL | typeof constants.DICTIONARY_SIZE_MEDIUM | typeof constants.DICTIONARY_SIZE_LARGE;
  export enum DictionarySizeBits {
    Small = constants.DICTIONARY_SIZE_SMALL,
    Medium = constants.DICTIONARY_SIZE_MEDIUM,
    Large = constants.DICTIONARY_SIZE_LARGE,
  }

  type PrivateImplodeState = {
  ...
  export declare function implode(
    compressionType: CompressionType,
    dictionarySizeBits: DictionarySizeBits,
    { debug = false, inputBufferSize = 0x0, outputBufferSize = 0x0 }: Config = {},
  ): PrivateState<PrivateImplodeState> & Handler;

  export const compress = implode;
  ...
  export declare function explode({
    debug = false,
    inputBufferSize = 0x0,
    outputBufferSize = 0x0,
  }: Config = {}): PrivateState<PrivateExplodeState> & Handler;

  export const decompress = explode;
